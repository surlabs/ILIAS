...
- Merge the fixes for LTI 1.3 Dynamic Registration into the maintained releases.
- Merge the fixes for LTI Deep Linking into the maintained releases.
- Merge the fixes for the LTI 1.3 Assignment and Grade Service into the maintained releases.
